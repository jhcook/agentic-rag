...
3. VERDICTS
   ...
   Rules:
   - Any SOC 2 or GDPR violation MUST result in BLOCK by the relevant role.
   - Any missing or clearly necessary docs MUST result in BLOCK by @Scribe.
   - Any obvious security issue MUST result in BLOCK by @Sentinel.
